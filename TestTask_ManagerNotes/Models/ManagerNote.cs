...
namespace TestTask_ManagerNotes.Models
{
    ...
    {
        [Key]
        public int ManagerNotesId { get; set; }

        [Column(TypeName ="varchar(200)")]
        [Display(Name = "Title of Note")]
        [Required(ErrorMessage = "Enter the title of note! ")]
        [Remote(action: "VerifyTitle", controller: "ManagerNote", ErrorMessage = "Длина строки должна быть от 3 до 200 символов")]
  
        public string Title { get; set; }

        [Column(TypeName = "varchar(2000)")]
        [Display(Name = "Text of Note")]
        [Remote(action: "VerifyTextOfNote", controller: "ManagerNote", ErrorMessage = "Длина строки должна быть от 3 до 2000 символов")]
        public string TextOfNote { get; set; }
        // public DateTime PublicationDate { get; set; }
        
    }

    public class ManagerNoteAll
    {
        public IEnumerable<ManagerNote> ManagerNotes { get; set; }
